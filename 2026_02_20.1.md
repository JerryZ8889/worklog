...
| open | Float | 中证500指数 | 基础K线 |
| high | Float | 中证500指数 | 止损判断 (entry_high) |
| low | Float | 中证500指数 | 基础K线 |
| close | Float | 中证500指数 | 均线计算、收益计算 |
| volume | Float | 中证500指数 | 成交量 (辅助) |
| amount | Float | 中证500指数 | Heat_Z 热度计算 |
...
| 2. Data Processor :<br>   a) 计算 breadth (广度)。<br>   b) 计算 etf_turnover (换手率)。<br>   c) 计算 ma_x (均线) 和 heat_z 。<br> |  |  |  |
